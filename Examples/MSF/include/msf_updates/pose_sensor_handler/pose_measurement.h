 ...
 private:
  ...
  virtual void MakeFromSensorReadingImpl(measptr_t msg) {
    ...
    /*  shared_ptr<EKFState_T> state_in;
      ...
      if (1){
        z_q_ = state.Get<StateDefinition_T::q_ic>() * state.Get<StateDefinition_T::q>() * (state.Get<StateDefinition_T::q_wv>().conjugate());
        z_p_ = state.Get<StateDefinition_T::q_wv>().toRotationMatrix() * (state.Get<StateDefinition_T::p>() + state.Get<StateDefinition_T::q>().toRotationMatrix() * state.Get<StateDefinition_T::p_ic>() ) * state.Get<StateDefinition_T::L>() + state.Get<StateDefinition_T::p_wv>();
      }*/
      /*************************************************************************************/
