...
public:
    ...
    cv::Mat TrackMonocular(const cv::Mat &im, const std::vector<cv::KeyPoint> &msKeys, const cv::Mat &msDescriptors, const double &timestamp);
...
public:
	System(const string &strVocFile, const string &strSettingsFile,
		...
		const bool reuse, const string & mapFilePath);
